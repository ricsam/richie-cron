...
import type { CronExpressionOptions } from '../src/CronExpression';
import { CronDate, TimeUnit } from '../src/CronDate';
import { CronFieldCollection } from '../src/CronFieldCollection';
import type { CronFields } from '../src/CronFieldCollection';
...
describe('CronExpression', () => {
  ...
  describe('iteration jump flows', () => {
    ...
    test('jumps to next allowed second without stepping via applyDateOperation()', () => {
      ...
      spy = spyOn(CronDate.prototype, 'applyDateOperation');
